...
public class DateConvert {
    ...
    public static int maxDayOfMonthm(int m, int y) {
        switch (m) {
            case 1:
                x = 31;
                break;
            case 2:
                x = DateConvert.mleap_year(y) ? 29 : 28;
                break;
            case 3:
                x = 31;
                break;
...
//        return m != 12 || DateConvert.mleap_year(y) ? 30 : 29;
        return x;
    }
    ...
    public static String mmonth2strf(int m) {
        String months[] = {
            "ژانویه", "فوریه", "مارس", "آوریل", "می", "ژوئن",
            "ژوئیه", "اوت", "سپتامبر", "اکتبر",
            "نوامبر", "دسامبر"
        };
        if (m <= 12 && m >= 1) {
            return months[m - 1];
    ...
    public static String gmonth2str(int m) {
        String months[] = {
    ...
    public static String mdayofweek2str(int wd) {
        String weekdays[] = {
            "Saturday", "Sunday", "Monday", "Thuesday", "Wednesday",
            "Thursday", "Friday"
        };
        if (wd <= 6 && wd >= 0) {
            return weekdays[wd];
    ...
    public static String todayFullm() {

        String today = todaym();
        return datetotextm(today);
    }

    public static String dayFullf(String date) {

        return datetotext(date);

    }

    public static String dayFullm(String date) {

        return datetotextm(date);

    }

    public static String dayFullg(String date) {

        return datetotextg(date);
    ...
    public static int hdayofweek(String instring) {
...
//            return mdayofweek2str(i + 1);
    ...
    public static String datetotextm(String datestr) {
            ...
            return (new StringBuilder()).
                    append(PersianTextNumber(dd)).append(" ").append(mmonth2strf(
                    mm)).append(" ").append(
                    PersianTextNumber(yy)).append(
                    " میلادی").
                    toString();
    ...
    public static String datetotextg(String datestr) {
            ...
            int yy = dcd[0];
            return (new StringBuilder()).
                    append(PersianTextNumber(dd)).append(" ").append(gmonth2str(
                    mm)).append(" ").append(
                    PersianTextNumber(yy)).append(
                    " هجری قمری").
                    toString();
...
//                             toString());
//        }
//        JOptionPane.showMessageDialog(null, todaym());
//        int [] a=hndifdate(1,29,12,1388);
//        System.out.println(todayFullm());
